/**
 * Example 6 (Local API version): EMA/RSI Scalper — 36 combos via local Cloud Optimizer server
 *
 * Start the server first:
 *   cd cloud-optimizer && DATABASE_URL="..." node server.js
 *
 * Then run this:
 *   node examples/example6_local.js
 *
...
(async () => {
  ...
  try {
    console.log(`=== Example 6 — Local Cloud Optimizer (${API_BASE}) ===\n`);
