 ...
 * @param {Object} [options]
 * @param {string} [options.chartId] - TradingView chart layout ID (optional — loads user's default chart if omitted)
...
async function openChart(page, options = {}) {
  ...
  const chartUrl = url || (chartId ? `https://www.tradingview.com/chart/${chartId}/` : DEFAULT_CHART_URL);
