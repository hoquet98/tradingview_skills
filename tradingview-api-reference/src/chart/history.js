...
module.exports = (client) => class HistorySession {
    ...
    /** @type {import('./study').StrategyReport} */
    #strategyReport = {
      trades: [],
      history: {},
      performance: {},
    ...
    /** @return {import('./study').StrategyReport} Get the strategy report if available */
    get strategyReport() {
    ...
    /**
   * Request deep backtest history data
   * @param {string} symbol Market symbol
   * @param {import('../classes/PineIndicator')} indicator PineIndicator with options set
   * @param {Object} options Options
   * @param {import('../types').TimeFrame} [options.timeframe] Chart period timeframe (Default is '5')
   * @param {number} [options.from] Start timestamp (Default is 2010-01-01)
   * @param {number} [options.to] End timestamp (Default is now)
